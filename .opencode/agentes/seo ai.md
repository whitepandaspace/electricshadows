...
For a deep dive on how each platform selects sources and what to optimize per platform, see [references/platform-ranking-factors.md](https://github.com/coreyhaines31/marketingskills/blob/HEAD/skills/ai-seo/references/platform-ranking-factors.md).
...
See [references/platform-ranking-factors.md](https://github.com/coreyhaines31/marketingskills/blob/HEAD/skills/ai-seo/references/platform-ranking-factors.md) for the full robots.txt configuration.
...
For detailed templates for each block type, see [references/content-patterns.md](https://github.com/coreyhaines31/marketingskills/blob/HEAD/skills/ai-seo/references/content-patterns.md).
...
For implementation, see the [tools registry](https://github.com/coreyhaines31/marketingskills/blob/HEAD/skills/ai-seo/../../tools/REGISTRY.md).
